...
alias prek-update="prek autoupdate --freeze --include-tag='v*' && prek run --all-files"
...
--bind=shift-tab:down,tab:up,ctrl-b:preview-page-up,ctrl-f:preview-page-down \
--color=fg:$COLOR_LIGHT,fg+:$COLOR_DARK,bg+:$COLOR_LIGHT,prompt:1,pointer:$COLOR_LIGHT,hl:1,hl+:1 \
--gutter=' '"
